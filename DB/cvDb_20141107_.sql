USE [master]
GO
/****** Oggetto:  Database [cv_db]    Data script: 07/22/2010 17:38:39 ******/
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = N'cv_db')
BEGIN
CREATE DATABASE [cv_db] ON  PRIMARY 
( NAME = N'cv_db', FILENAME = N'C:\root\dataSql\dat\cv_db.mdf' , SIZE = 40128KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'cv_db_log', FILENAME = N'C:\root\dataSql\log\cv_db_log.LDF' , SIZE = 1024KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
...
USE [cv_db]
GO
/****** Oggetto:  User [applicationuser]    Data script: 07/22/2010 17:38:42 ******/
GO
...
GO
/****** Oggetto:  Table [dbo].[utente]    Data script: 07/22/2010 17:38:42 ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Oggetto:  Table [dbo].[settoreCandidatura_LOOKUP]    Data script: 07/22/2010 17:38:42 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_candidato_LOAD]    Data script: 07/22/2010 17:38:42 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_doc_multi_SEARCH_CandidateDocuments]    Data script: 07/22/2010 17:38:42 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_permesso_INSERT]    Data script: 07/22/2010 17:38:42 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  Table [dbo].[areaAziendale_LOOKUP]    Data script: 07/22/2010 17:38:42 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  Table [dbo].[livelloFunzionario_LOOKUP]    Data script: 07/22/2010 17:38:42 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_ViewCacher_generic_LOAD_interval]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_ViewCacher_generic_LOAD_length]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[LogViewer_web_cvDb]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_ViewCacher_generic_DROP]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_ViewCacher_specific_CREATE_candidato]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_ViewCacher_specific_CREATE_documento]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_ViewCacher_specific_CREATE_Primes]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  Table [dbo].[permesso]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  Table [dbo].[lCrash]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  Table [dbo].[candidato]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  Table [dbo].[doc_multi]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  Table [dbo].[settoreAziendale_LOOKUP]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_utente_ChangePwd]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_permesso_LOADSINGLE]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_permesso_GetNonCensiti]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_utente_INSERT]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_utente_LOADDECODEDSINGLE]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_utente_LOADMULTI]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_utente_LOADSINGLE]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_utente_UPDATE]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_doc_multi_getId_at_refCandidatoId]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_settoreCandidatura_LOOKUP_LOAD]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_settoreCandidatura_LOOKUP_INSERT]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_candidato_LOAD_Description]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_candidato_note_UPDATE]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_candidato_INSERT]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_candidato_note_LOAD]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_doc_multi_INSERT]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_doc_multi_dataMining]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_doc_multi_get_sourceName]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_doc_multi_getBlobAtId]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_doc_multi_abstract_LOAD]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_doc_multi_abstract_UPDATE]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_lCrash_CheckLine]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_lCrash_INSERT]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_lCrash_LOADSINGLE]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Oggetto:  StoredProcedure [dbo].[usp_lCrash_UPDATE]    Data script: 07/22/2010 17:38:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[usp_candidato_LOAD_search]    Script Date: 11/10/2014 12:13:13 ******/
SET ANSI_NULLS ON
GO
