...
/****** Object:  Database [cv_db]    Script Date: 08/29/2018 13:49:39 ******/
...
where Beneficiario like '%Torre%'

--update Telecom.dbo.lottoDue_produzione
--set
--	numero='3484099121'
--	,attivazione='2018-08-29 10:00:00.000'
--	,PIN='0503'
--	,PUK='13298173'
--	,soglie='INFORMATIVA mensile: 800 minuti voce; 800 sms; 5Gb dati; '
--	,note='ICCID=''8939010001980907881 – L56C''. Attivata il 2018.08.29 per Torresani, con acquisizione di utenza personale Vodafone.'
--where id=75

pin 0503 puk 13298173