...
class Program//-----------test------------
{
    ...
    {
        EntityBulk_Csharp_Win_.EntityBulk_Template_<EntityBulk_Csharp_Win_.someRecordLayout> eBspecif =
        ...
        // re-read.
        int step = +1;
        for (EntityBulk_Csharp_Win_.EntityBulk_Template_<EntityBulk_Csharp_Win_.someRecordLayout>.iterator it = eBspecif.begin();
