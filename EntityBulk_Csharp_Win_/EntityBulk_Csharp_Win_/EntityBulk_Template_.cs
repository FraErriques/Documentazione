...
namespace EntityBulk_Csharp_Win_
{
    ...
    public class EntityBulk_Template_<RecordLayout> where RecordLayout : new()
    {
        ...
        public class iterator //----internal class -------------------------------------------------
        {
            ...
            //  * or property 'EntityBulk_Csharp_Win_.EntityBulk_Template_<RecordLayout>.iterator.current'	
            //  */
            //    return current;
            //}
            ...
            public void BKWD( RecordLayout[] envelopeData )
            {
        ...
        {
            EntityBulk_Csharp_Win_.EntityBulk_Template_<RecordLayout>.iterator curIterator = new EntityBulk_Csharp_Win_.EntityBulk_Template_<RecordLayout>.iterator();
    ...
    }//  class EntityBulk_Template_<RecordLayout>
